...
| [Module 5: Autoencoder](./05-module-5-autoencoder.md)                           | Not started   |                                                                                                                                  | Reconstruction error anomaly detection; latent space visualization; bottleneck experiment; NASA SMAP/MSL scale benchmark |
