...
| [Module 5: Autoencoder](./05-module-5-autoencoder.md)                           | **In progress** | `@notebooks/05-swat-autoencoder.ipynb`                                                                                        | Reconstruction error anomaly detection on SWaT; feedforward AE vs. Mahalanobis/IF; data-driven threshold calibration |
| [Module 6: LSTM-Autoencoder](./06-module-6-lstm-autoencoder.md)                 | **In progress** | `@notebooks/06-swat-lstm-ae.ipynb`                                                                                             | Temporal model vs. static model on slow drift; LSTM-AE vs feedforward AE on SWaT; sequence length analysis |
| [Module 7: Comparative evaluation](./07-module-7-comparative-evaluation.md)     | Not started   |                                                                                                                                  | Full comparison table; health indicator construction; synthesis write-up                  |
