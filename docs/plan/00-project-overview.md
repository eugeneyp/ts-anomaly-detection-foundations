...
| [Module 6: LSTM-Autoencoder](./06-module-6-lstm-autoencoder.md)                 | **In progress** | `@notebooks/06-swat-lstm-ae.ipynb`                                                                                            | LSTM-AE on SWaT; F1 0.7133 (p99.9, 20 epochs, stride=60) — temporal modeling regressed vs feedforward AE; point-like attacks diluted by stride-1 averaging; rerunning with stride=30, 40 epochs |
