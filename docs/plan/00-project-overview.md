...
| [Module 3: Mahalanobis distance](./03-module-3-mahalanobis-distance.md)         | **Completed** | `@notebooks/03-skab-valve1-0.ipynb`                                                                                              | First multivariate method on SKAB; comparison with univariate z-scores                    |
