...
| [Module 4: Isolation Forest and OCSVM](./04-module-4-isolation-forest-ocsvm.md) | **Completed** | `@notebooks/04-swat-isolation-forest.ipynb`                                                                                      | Isolation Forest (51 features: 26 continuous + 25 binary actuators) vs. Mahalanobis on SWaT; OCSVM omitted (O(n²) scale constraint on 1.38M training rows); contamination hyperparameter sweep |
